...
import 'package:salex/ui/Troublelogin/resetPassword.dart';
import 'package:salex/Animations/FadeAnimation.dart';
import 'package:salex/Controllers/ApiServices/SendResetMailService.dart';
                    ...
                    child: InkWell(
                          ...
                          if (validateEmail()) {
                            ...
                            SendResetMailService.SendResetEmail(body)
                              ...
                              if (success) {
                                ...
                                pr.hide();
                                _errorTxt =
                                    "This Email doesnt blongs to an account !";
                              }
                            });
                          }
                        } else {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            //   colors: [Color(0xFF001B87), Color(0xFF30E7ED)],
                            // ),
                            borderRadius:
                                BorderRadius.all(Radius.circular(10))),
                        child: Center(
                          child: Text(
                            'Send Tempory Login'.toUpperCase(),
                            style: TextStyle(
                                fontSize: 16,
                                color: Colors.white,
                                fontFamily: 'Montserrat',
